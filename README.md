...
if not autorizado then
    warn("âŒ Acesso negado para: " .. player.Name)
    task.wait(1)
    player:Kick("âŒ VocÃª nÃ£o estÃ¡ autorizado a usar este script.")
    return
end

print("âœ… Acesso autorizado para:", player.Name)
...
-- Detecta em qual base o jogador estÃ¡
...
-- Determina rota do inimigo (oposta Ã  minha base)
...
-- Faz o TP em sequÃªncia para a base do inimigo
local function tpToEnemyBase()
    ...
    -- getEnemyRoute() retorna "B" quando minha base Ã© LEFT (Z alto) â†’ inimigo Ã© RIGHT
    -- getEnemyRoute() retorna "A" quando minha base Ã© RIGHT (Z baixo) â†’ inimigo Ã© LEFT
...
local function agGetAnimalName(prompt)
    ...
    local function isIgnored(text)
        ...
        local ignoreList = {
            "steal","coletar","epico","Ã©pico","raro","comum","lendario","lendÃ¡rio",
...
-- A GUI cresceu em altura para acomodar o botÃ£o TP (490 â†’ 540)
local main = Instance.new("Frame")
main.Size = UDim2.new(0, PANEL_W, 0, PANEL_H)

-- PosiÃ§Ã£o inicial: canto superior direito, garantindo que nÃ£o saia da tela
...
-- AUTO-PLAY com keybind configurÃ¡vel
local autoPlayBtn = MakeBtn("AUTO-PLAY: OFF", 231, 148, 12)

-- BotÃ£o de bind ao lado do AUTO-PLAY
...
-- ============================================
-- SEÃ‡ÃƒO TP BRAINROT (acima do Auto Grab)
-- ============================================
MakeSectionLabel("TELEPORTE:", 336)
local tpBtn = MakeBtn("âš¡ TP BRAINROT", 351, 196, 12)

-- Feedback visual no botÃ£o TP manual
...
-- â”€â”€ Seletor de cor â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
do
...
-- ============================================
-- KEYBINDS LISTENER â€” bind dinÃ¢mico do AUTO-PLAY
-- ============================================
